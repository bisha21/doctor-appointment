...
import { ArrowRight, Stethoscope, StethoscopeIcon } from "lucide-react";
        ...
        <div className="container mx-auto px-4 ">
          <div className=" grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-8">
              <Badge
                variant="outline"
                className="bg-emerald-900/30 border border-emerald-700/30 px-4 py-2 rounded-md"
              >
      ...
      <section className="py-20 bg-muted/30">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 " >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Book appointments, consult via video, and manage your healthcare journey all in one secure platform.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((features, index) => {
              return (
                <Card key={index}
                  className="border-emerald-900/30 hover:border-emerald-800/40 transition-all">
                  <CardHeader>
                    <div className="bg-emerald-900/20 p-3 rounded-lg mb-4 w-fit">
                      {
                        features.icon
                      }
                    </div>
      ...
      <section className="py-20 bg-muted/30">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mx-auto">
            ...
            <Card className="mt-12 bg-muted/30 border-emerald-900/30">
              <CardHeader>
                <CardTitle className="text-xl font-semibold text-white flex items-center  ">
                  <StethoscopeIcon className="h-5 w-5 mr-2 text-emerald-400" />
